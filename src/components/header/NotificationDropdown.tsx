...
export default function NotificationDropdown() {
  ...
  useEffect(() => {
    async function loadNotifications() {
      try {
        console.log('API BASE URL:', process.env.NEXT_PUBLIC_API_BASE_URL, process.env);
  ...
  //     try {
  //       const res = await fetch('/api/notifications/postNotification', {
  //         method: 'POST',
  //         headers: { 'Content-Type': 'application/json' },
  //         body: JSON.stringify({ message: "requests", request: "Admin access", requestedBy: "Tyler Ross" }),
  //       });
