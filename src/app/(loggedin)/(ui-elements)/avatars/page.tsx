...
export const metadata: Metadata = {
  title: 'HridhyaTechAvatars | Admin - HridhyaTechDashboard Template',
  description:
    'This is HridhyaTechAvatars page for Admin - HridhyaTechTailwind CSS Admin Dashboard Template',
};
