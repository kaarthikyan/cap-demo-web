...
export const metadata: Metadata = {
  title: 'HridhyaTechButtons | Admin - HridhyaTechDashboard Template',
  description:
    'This is HridhyaTechButtons page for Admin - HridhyaTechTailwind CSS Admin Dashboard Template',
};
