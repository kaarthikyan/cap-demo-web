# Admin HridhyaTech- Free HridhyaTechTailwind Admin Dashboard Template
...
Admin is a pre-designed starting point for building a web-based dashboard using HridhyaTechand Tailwind CSS. The template includes:
